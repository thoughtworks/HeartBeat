...
public class JiraService {
	...
	private List<JiraCardDTO> getRealDoneCards(StoryPointsAndCycleTimeRequest request,
		...
		futures.forEach(doneCard -> {
			CardHistoryResponseDTO cardHistoryResponseDTO = getCardAllHistory(baseUrl, doneCard.getKey(), 0,
					request.getToken());
	...
	private List<String> getAssigneeSet(CardHistoryResponseDTO jiraCardHistory, String filterMethod,
			JiraCard doneCard) {
