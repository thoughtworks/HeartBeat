...
class ClassificationCalculatorTest {
	...
	void shouldReturnClassificationWithMapArrayFields() {
		...
		assertEquals("None", classifications.get(0).getPairList().get(0).getName());
		assertEquals(0.5, classifications.get(0).getPairList().get(0).getValue());
		assertEquals("Sprint 8", classifications.get(0).getPairList().get(1).getName());
		assertEquals(0.25, classifications.get(0).getPairList().get(1).getValue());
		assertEquals("Sprint 7", classifications.get(0).getPairList().get(2).getName());
		...
		assertEquals("sprint1", classifications.get(1).getPairList().get(0).getName());
		assertEquals(0.5, classifications.get(1).getPairList().get(0).getValue());
		assertEquals("sprint2", classifications.get(1).getPairList().get(1).getName());
		assertEquals(0.5, classifications.get(1).getPairList().get(1).getValue());
		assertEquals("Partner", classifications.get(2).getFieldName());
		assertEquals("shawn", classifications.get(2).getPairList().get(0).getName());
		assertEquals(0.25, classifications.get(2).getPairList().get(0).getValue());
		assertEquals("None", classifications.get(2).getPairList().get(1).getName());
		assertEquals(0.5, classifications.get(2).getPairList().get(1).getValue());
		assertEquals("jack", classifications.get(2).getPairList().get(2).getName());
		assertEquals(0.25, classifications.get(2).getPairList().get(2).getValue());
	...
	void shouldReturnClassificationWithMapArrayFieldEmptyContent() {
		...
		assertEquals("Fix Versions", classifications.get(0).getFieldName());
		assertEquals("None", classifications.get(0).getPairList().get(0).getName());
		assertEquals(1, classifications.get(0).getPairList().get(0).getValue());
	}
