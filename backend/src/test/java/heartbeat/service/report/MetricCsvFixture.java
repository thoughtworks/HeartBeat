	...
	public static ReportResponse MOCK_METRIC_CSV_DATA() {
		return ReportResponse.builder()
			...
			.classificationList(List.of(Classification.builder()
				...
				.pairList(List.of(ClassificationNameValuePair.builder()
						.name("Bug")
						.value(0.3333333333333333)
						.build(),
					ClassificationNameValuePair.builder()
						.name("Story")
			...
			.cycleTime(CycleTime.builder()
				...
				.swimlaneList(List.of(CycleTimeForSelectedStepItem.builder()
			...
			.deploymentFrequency(DeploymentFrequency.builder()
				...
				.deploymentFrequencyOfPipelines(List.of(DeploymentFrequencyOfPipeline.builder()
						...
						.dailyDeploymentCounts(List.of(DailyDeploymentCount.builder()
							.date("10/16/2023")
							.count(1)
							.build()))
						.build(),
			...
			.meanTimeToRecovery(MeanTimeToRecovery.builder()
				.avgMeanTimeToRecovery(AvgMeanTimeToRecovery.builder()
					.timeToRecovery(BigDecimal.valueOf(0)).build())
