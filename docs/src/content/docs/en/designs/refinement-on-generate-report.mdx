...
201 Created
{
    ...
    "boardMetricsReady": true <default is false>, 
    "pipelineMetricsReady": true <default is false>, 
    "sourceControlMetricsReady": true <default is false>,
    "allMetricsReady": true <default is false>,
