export default {
	...
	// Site settings
	'site.title': 'Heartbeat Documentation',
	'site.description': 'Build faster websites with less client-side JavaScript.',
	'site.og.imageSrc': '/default-og-image.png?v=1',
	'site.og.imageAlt':
		'Heartbeat logo on a starry expanse of space, with a purple saturn-like planet floating in the right foreground',
	// Left Sidebar
	'leftSidebar.a11yTitle': 'Primary',
	'leftSidebar.techTab': 'Tech',
	'leftSidebar.bizTab': 'Biz',
	...
	'stub.description.migration':
		'Want to contribute to this guide? Have a blog post, video, or another resource to share about migrating from this technology to Heartbeat?',
	'stub.description.cms': 'Know more about how to use this CMS with Heartbeat?',
	'stub.description.backend': 'Know more about how to use this backend service with Heartbeat?',
};
