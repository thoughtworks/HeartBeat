...
| :----- | :------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| 1      | Move to Block column after flag duration                                               | ![img1.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/block-after-flag.png)                | Time between `Add flag` and `Remove flag` + Time in `block` column                                                                | Time in `block` column                                 |
| 2      | Move out Block column before flag duration                                             | ![img2.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/block-before-flag.png)               | Time between `Add flag` and `Remove flag` + Time in `block` column                                                                | Time in `block` column                                 |
| 3      | Block column duration within flag duration                                             | ![img3.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/block-witnin-flag.png)               | Time between `Add flag` and `Remove flag`                                                                                         | Time in `block` column                                 |
| 4      | Flag duration within Block duration                                                    | ![img4.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/flag-within-block.png)               | Time in `block` column                                                                                                            | Time in `block` column                                 |
| 5      | Block duration partial cross flag duration and block start time before flag start time | ![img5.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/block-partial-cross-flag-before.png) | Time between `Add flag` and `Remove flag` + Time in `block` column - Overlap time                                                 | Time in `block` column                                 |
| 6      | Block duration partial cross flag duration and block end time after flag end time      | ![img6.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/block-partial-cross-flag-after.png)  | Time between `Add flag` and `Remove flag` + Time in `block` column - Overlap time                                                 | Time in `block` column                                 |
| 7      | Flag duration partial cross realDone duration                                          | ![img7.png](https://jsd.cdn.zzko.cn/gh/au-heartbeat/data-hosting@main/cycle-time-image/flag-partial-cross-done.png)         | Time between `Add flag` and `Remove flag` + Time in `block` column - `flag` and `block` cross time - `flag` and `done` cross time | Time in `block` column                                 |
