...
describe('Cycle Time component', () => {
  ...
  const mockCycleTimeData = [
    { id: 1, name: 'Average cycle time', value: ['21.18', '30.26'] },
    { id: 2, name: 'Total development time/Total cycle time', value: ['0.57'] },
    { id: 3, name: 'Total waiting time/Total cycle time', value: ['0.01'] },
    { id: 4, name: 'Total block time/Total cycle time', value: ['0.40'] },
    { id: 5, name: 'Total review time/Total cycle time', value: ['0.01'] },
    { id: 6, name: 'Total testing time/Total cycle time', value: ['0.00'] },
    { id: 7, name: 'Average development time', value: ['12.13', '17.32'] },
    { id: 8, name: 'Average waiting time', value: ['0.16', '0.23'] },
    { id: 9, name: 'Average block time', value: ['8.54', '12.20'] },
    { id: 10, name: 'Average review time', value: ['0.26', '0.36'] },
    { id: 11, name: 'Average testing time', value: ['0.10', '0.14'] },
  ]
