...
import { BOARD_FIELDS, BOARD_TYPES, CONFIG_TITLE_BOARD, ERROR_MESSAGE_COLOR } from '../../../fixtures'
...
describe('Board', () => {
  it('should show board title and fields when render board component ', () => {
    ...
    expect(getByRole('heading', { name: CONFIG_TITLE_BOARD })).toBeInTheDocument()
  })
