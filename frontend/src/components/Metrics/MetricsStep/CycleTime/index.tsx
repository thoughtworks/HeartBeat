...
export const CycleTime = ({ columns, title }: cycleTimeProps) => {
  ...
  const getDefaultOptionValue = (
    ...
    const validImportValue = cycleTimeSettings?.find((i) => Object.keys(i)[0] === controlName)
  ...
  const defaultValue = Object.values(columns).map((item) => getDefaultOptionValue(item, cycleTimeSettings))
